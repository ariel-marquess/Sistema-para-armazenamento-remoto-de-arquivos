def openFolder():
    ...
    # Utilize as propriedades dos objetos do Python e, para o envio de retorno ao cliente, transforme a variável que contém os objetos em um arquivo JSON para envio (facilitará o tratamento dos dados após o recebimento).
    return False
